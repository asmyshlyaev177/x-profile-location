 ...
 */
export async function officialAccountLocation(page: Page, screenName: string): Promise<LocationInfo> {
 ...
 */
export async function navigateToTweetDetail(page: Page, screenName: string): Promise<string> {
 ...
 */
export async function hoverOwnTweet(page: Page, screenName: string): Promise<Locator> {
  await page.goto(`https://x.com/${screenName}`);
